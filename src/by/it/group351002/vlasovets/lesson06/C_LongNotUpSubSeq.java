...
public class C_LongNotUpSubSeq {
    ...
    int getNotUpSeqSize(InputStream stream) throws FileNotFoundException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            for (int j = 0; j < i; j++) {
                // Если m[i] меньше или равно m[j] и длина подпоследовательности, заканчивающейся на j-м элементе,
            ...
            // Обновляем максимальную длину невозрастающей подпоследовательности.
